...
public class ProjectServiceImpl implements ProjectService {
    ...
    public List<ProjectDetails> getProjects(Jwt jwt) {
        ...
        Map<UUID, List<ProjectMember>> membersByProject = projectMemberRepository.findAllByProject_IdIn(projectIds)
                .stream()
    ...
    private ProjectDetails toDetails(
                ...
                .map(member -> {
                    ...
                    return new Member(
                            ...
                            member.getCreatedAt() == null ? null
                                    : member.getCreatedAt().atOffset(ZoneOffset.UTC).toString(),
        ...
        List<Model> modelDtos = models.stream()
                ...
                .map(model -> new Model(
                        ...
                        toPaymentItemDtos(paymentItemsByModel.getOrDefault(model.getId(), List.of()))))
                .toList();
