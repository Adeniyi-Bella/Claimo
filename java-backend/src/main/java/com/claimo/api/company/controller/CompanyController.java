...
public class CompanyController {
    ...
    public ResponseEntity<CustomApiResponse<CompanyResponses.CurrentCompany>> getMyCompany(
            @AuthenticationPrincipal Jwt jwt) {
        return ResponseEntity.ok(CustomApiResponse.success(companyService.getCurrentCompany(jwt)));
    }
}
